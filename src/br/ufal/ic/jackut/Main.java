...
public class Main {
    public static void main(String[] args) {
        ...
        EasyAccept.main(new String[] { facadeClass, "src/tests/us8_1.txt" });
        EasyAccept.main(new String[] { facadeClass, "src/tests/us8_2.txt" });
        EasyAccept.main(new String[] { facadeClass, "src/tests/us9_1.txt" });
        EasyAccept.main(new String[] { facadeClass, "src/tests/us9_2.txt" });
    }
}
